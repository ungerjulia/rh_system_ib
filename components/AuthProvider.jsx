...
function LoginPage() {
  ...
  const login = async () => {
    ...
    try {
      ...
      setError("Erro ao entrar. Verifique se está usando o e-mail @independentbrazil.com")
    }
    setLoading(false)
  }
  ...
  return (
    <div className="login-page">
      <div className="login-card">
        ...
        <p className="login-sub">Recrutamento inteligente com IA</p>
        ...
        <p className="login-hint">Acesso restrito a @independentbrazil.com</p>
      </div>
    </div>
  )
}
